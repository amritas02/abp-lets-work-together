...
class FourTowerSequential():
    ...
    def step(self, action):
        ...
        ###########################################
        state = observation[3]['feature_screen']
        # dict_keys(['control_groups', 'cargo_slots_available', 'player', 'build_queue', 'action_result', 'multi_select', 'single_select', 'game_loop', 'alerts', 'score_cumulative', 'feature_units', 'cargo', 'available_actions', 'last_actions', 'feature_minimap', 'feature_screen'])

        #print((observation[3]['feature_screen']['visibility_map']))
    ...
    def int_map_to_onehot(self, x, vocabulary=None):
        ...
        onehot = np.reshape(onehot, [1, 27200])
        return onehot
